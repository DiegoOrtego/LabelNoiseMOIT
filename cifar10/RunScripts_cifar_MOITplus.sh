...
python3 train_MOITplus.py --epoch 70 --num_classes 10 --batch_size 128 --noise_ratio 0.4 \
--network "PR18" --lr 0.001 --wd 1e-4 --dataset "CIFAR-10" --method "MOIT" \
...
python3 train_MOITplus.py --epoch 140 --num_classes 10 --batch_size 128 --M 120 --noise_ratio 0.8 \
--network "PR18" --lr 0.001 --wd 1e-4 --dataset "CIFAR-10" --method "MOIT" \
